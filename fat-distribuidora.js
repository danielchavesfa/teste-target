...
const totalMensal = dados.reduce((acumulador, faturamentoMensal) => {
  return faturamentoMensal.valor+acumulador
}, 0);

for (const estado of dados) {
  console.log(`Valor ${estado.estado} %${((estado.valor/totalMensal)*100).toFixed(2)}`)
};